...
class FromPresenter extends Presenter implements Searchable, Personable
{
    ...
    public function title(): string
    {
        ...
        return "ФИО: ".$this->entity->from_name;
    }

    public function subTitle(): string
    {
        // TODO: Implement subTitle() method.
        return "Город: ".City::find($this->entity->from_city)->city_name;
    }
